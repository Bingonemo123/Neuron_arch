...
"""FileHandler"""
rotatingfile_handler = logging.handlers.RotatingFileHandler(path.parent/ (file_path.stem + '.log'), backupCount=5, maxBytes=1073741824)
...
logger.info('Archive Entry ' + str(experiment_number))
'''-------------------------------------------------------------------------------------------------'''
